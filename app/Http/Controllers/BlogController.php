	...
	public static function articles($limit = false)
	{
		$articles = [
			...
			'oculus-rift-virtual-experience-trials' => [
				...
				'keywords' => ['oculus', 'rift', 'vr', 'museum of the microstar', 'tuscany world', 'team fortress'],
				'tags'     => ['Oculus Rift', 'Unity', 'Virtual Reality']
			],
			'experiments' => [
				'title'    => 'Experiments',
				...
				'image'    => false,
				'keywords' => ['labs', 'experiments', 'partical generator'],
				'tags'     => ['Canvas', 'Eye', 'HTML5', 'jQuery', 'Maths', 'Particles', 'PI', 'Sin', 'Cos']
			],
			'my-route-into-a-career-in-programming' => [
				...
				'image'    => false,
				'keywords' => [],
				'tags'     => ['Career', 'History', 'Programming']
			],
			...
			'performance-enhanced-loops-in-javascript' => [
				...
				'image'    => false,
				'keywords' => [],
				'tags'     => ['JavaScript', 'Enhancing', 'Guide', 'Performance', 'Useful']
			],
			'todays-date-automated-on-twitter' => [
				...
				'image'    => false,
				'keywords' => [],
				'tags'     => ['Cron Jobs', 'Fun', 'Short Project']
			],
			'youre-officially-for-sale-on-instagram' => [
				...
				'image'    => false,
				'keywords' => [],
				'tags'     => ['Instagram', 'Flickr', 'Privacy', 'TOS']
			],
			...
			'facebook-photo-sync' => [
				...
				'image'    => false,
				'keywords' => [],
				'tags'     => ['Android', 'iOS', 'Photo Sync', 'Apple', 'iPhone']
			],
			'a-trip-through-space-with-a-google-experiment' => [
				...
				'keywords' => [],
				'tags'     => ['Aaron Koblin', 'Chrome', 'CSS3D', 'Experiment', 'Mass Effect', 'Sam Hulick', 'Space', 'Web Audio', 'WebGL']
			],
			'your-passwords-are-never-good-enough' => [
				...
				'image'    => false,
				'keywords' => [],
				'tags'     => ['Mat Honan', 'Passwords', 'Security', 'Wired']
			],
			'codeigniter-multiple-development-environments' => [
				...
				'image'    => false,
				'keywords' => [],
				'tags'     => ['CI', 'Code Igniter', 'Coding', 'Plugin', 'Time Saver', 'Useful']
			],
		];
